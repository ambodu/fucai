  ...
  return (
    <nav className="glass border-b border-[#ebebed] sticky top-0 z-50 hidden lg:block">
      <div className="max-w-[1200px] mx-auto flex items-center justify-between h-12 px-6">
        ...
        <Link
          href="/ai"
          className="flex items-center gap-1.5 px-5 py-1.5 rounded-full bg-[#0071e3] text-white text-sm font-medium hover:bg-[#0077ed] transition-all hover:shadow-sm shrink-0"
        >
          <Sparkles size={13} />
          AI 分析
        </Link>
