...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="relative max-w-[1200px] mx-auto px-4 lg:px-6 py-20 lg:py-32 text-center">
        {/* Status badge */}
        {latest && (
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#f5f5f7] mb-8 animate-fade-in">
        ...
        {/* Subtitle */}
        <p className="text-lg lg:text-xl text-[#6e6e73] max-w-2xl mx-auto mb-10 animate-fade-in-up font-normal leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-fade-in-up">
          <Link
            href="/ai"
            className="inline-flex items-center gap-2 bg-[#0071e3] text-white rounded-full px-8 py-3.5 text-base font-medium shadow-apple hover:bg-[#0077ed] transition-all hover:shadow-apple-lg"
          >
            <Sparkles size={18} />
            开始 AI 分析
          </Link>
          <Link
            href="/trend"
            className="inline-flex items-center gap-2 bg-[#f5f5f7] text-[#1d1d1f] rounded-full px-8 py-3.5 text-base font-medium hover:bg-[#ebebed] transition-colors"
          >
            浏览走势图
            <ArrowRight size={16} />
          </Link>
        ...
        {/* Trust stats */}
        <div className="flex flex-wrap items-center justify-center gap-8 lg:gap-16 animate-fade-in">
          {[
            ...
            <div key={stat.label} className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-[#1d1d1f]">{stat.value}</div>
